...
Command: npx gltfjsx@6.5.3 D:\PairToPixel\public\models\powerbank HT for web 05.glb --output src/components/PowerbankModel.jsx 
*/

import React from 'react'
import { useGLTF } from '@react-three/drei'

// This is the NAMED EXPORT: export function Model
export function Model(props) {
  const { nodes, materials } = useGLTF('/models/powerbank HT for web 05.glb') 
  return (
...
useGLTF.preload('/models/powerbank HT for web 05.glb') 
